...
namespace Microsoft.Research.SEAL
{
    ...
    public class Evaluator : NativeObject
    {
        ...
        /// Subtracts two ciphertexts.
        /// </summary>
        /// <remarks>This function computes the difference of encrypted1 and encrypted2 and stores the result in the
        ...
        /// </summary>
        /// <remarks>
        /// This functions computes the product of encrypted1 and encrypted2 and stores the result in encrypted1.
        ...
        /// <exception cref="ArgumentException">if encrypted1 or encrypted2 is not valid for the encryption
        /// parameters</exception>
        /// <exception cref="ArgumentException">if encrypted1 or encrypted2 is not in the default NTT form</exception>
        /// <exception cref="ArgumentException">if encrypted1 and encrypted2 are at different level</exception>
        ...
        /// </summary>
        /// <remarks>
        /// This functions computes the product of encrypted1 and encrypted2 and stores the result in the destination
        /// parameter. Dynamic memory allocations in the process are allocated from the memory pool pointed to by the
        ...
        /// <param name="pool">The MemoryPoolHandle pointing to a valid memory pool</param>
        /// <exception cref="ArgumentNullException">if encrypted1, encrypted2, destination is null</exception>
        /// <exception cref="ArgumentException">if encrypted1 or encrypted2 is not in the default NTT form</exception>
        /// <exception cref="ArgumentException">if encrypted1 and encrypted2 are at different level</exception>
        /// <exception cref="ArgumentException">if the output scale is too large for the encryption
        /// parameters</exception>
        ...
        /// </summary>
        /// <remarks>
        /// This functions computes the square of encrypted. Dynamic memory allocations in the process are allocated
        ...
        /// </summary>
        /// <remarks>
        /// This functions computes the square of encrypted and stores the result in the destination parameter. Dynamic
        ...
        /// <param name="pool">The MemoryPoolHandle pointing to a valid memory pool</param>
        /// <exception cref="ArgumentNullException">if encrypted, destination is null</exception>
        /// <exception cref="ArgumentException">if encrypted is not valid for the encryption parameters</exception>
        /// <exception cref="ArgumentException">if encrypted is not in the default NTT form</exception>
        /// <exception cref="ArgumentException">if the output scale is too large for the encryption
        /// parameters</exception>
        ...
        /// </summary>
        /// <remarks>
        /// This functions relinearizes encrypted, reducing its size down to 2. If the size of encrypted is K+1, the
        /// given relinearization keys need to have size at least K-1. Dynamic memory allocations in the process are
        ...
        /// parameters</exception>
        /// <exception cref="ArgumentException">if encrypted is not in the default NTT form</exception>
        /// <exception cref="ArgumentException">if relinKeys do not correspond to the top level parameters in the
        ...
        /// </summary>
        /// <remarks>
        /// This functions relinearizes encrypted, reducing its size down to 2, and stores the result in the destination
        /// parameter. If the size of encrypted is K+1, the given relinearization keys need to have size at least K-1.
        /// Dynamic memory allocations in the process are allocated from the memory pool pointed to by the given
        /// MemoryPoolHandle.
        /// </remarks>
        /// <param name="encrypted">The ciphertext to relinearize</param>
        ...
        /// <param name="pool">The MemoryPoolHandle pointing to a valid memory pool</param>
        /// <exception cref="ArgumentNullException">if encrypted, relinKeys, or destination is null</exception>
        /// <exception cref="ArgumentException">if encrypted or relinKeys is not valid for the encryption
        /// parameters</exception>
        /// <exception cref="ArgumentException">if encrypted is not in the default NTT form</exception>
        /// <exception cref="ArgumentException">if relinKeys do not correspond to the top level parameters in the
        ...
        /// parameters reach the given ParmsId.
        /// </summary>
        /// <param name="plain">The plaintext to be switched to a smaller modulus</param>
        /// <param name="parmsId">The target parmsId</param>
        /// <exception cref="ArgumentNullException">if plain or parmsId is null</exception>
        /// <exception cref="ArgumentException">if plain is not in NTT form</exception>
        /// <exception cref="ArgumentException">if plain is not valid for the encryption parameters</exception>
        /// <exception cref="ArgumentException">if parmsId is not valid for the encryption parameters</exception>
        /// <exception cref="ArgumentException">if plain is already at lower level in modulus chain than the parameters
        /// corresponding to parmsId</exception>
        /// <exception cref="ArgumentException">if the scale is too large for the new encryption parameters</exception>
        ...
        /// <summary>
        /// Given an NTT transformed plaintext modulo q_1...q_k, this function switches the modulus down until the
        /// parameters reach the given ParmsId and stores the result in the destination parameter.
        /// </summary>
        /// <param name="plain">The plaintext to be switched to a smaller modulus</param>
        /// <param name="parmsId">The target parmsId</param>
        /// <param name="destination">The plaintext to overwrite with the modulus switched result</param>
        /// <exception cref="ArgumentNullException">if plain, parmsId, or destination is null</exception>
        /// <exception cref="ArgumentException">if plain is not in NTT form</exception>
        /// <exception cref="ArgumentException">if plain is not valid for the encryption parameters</exception>
        /// <exception cref="ArgumentException">if parmsId is not valid for the encryption parameters</exception>
        /// <exception cref="ArgumentException">if plain is already at lower level in modulus chain than the parameters
        ...
        /// <summary>
        /// Given a ciphertext encrypted modulo q_1...q_k, this function switches the modulus down to q_1...q_{k-1},
        /// scales the message down accordingly, and stores the result in the destination parameter.
        /// </summary>
        /// <remarks>
        /// Given a ciphertext encrypted modulo q_1...q_k, this function switches the modulus down to q_1...q_{k-1},
        /// scales the message down accordingly, and stores the result in the destination parameter. Dynamic memory
        ...
        /// <exception cref="ArgumentException">if the scheme is invalid for rescaling</exception>
        /// <exception cref="ArgumentException">if encrypted is not valid for the encryption parameters</exception>
        /// <exception cref="ArgumentException">if encrypted is not in the default NTT form guaranteed to be</exception>
        /// <exception cref="ArgumentException">if encrypted is already at lowest level</exception>
        /// <exception cref="ArgumentException">if pool is uninitialized</exception>
        /// <exception cref="InvalidOperationException">if result ciphertext is transparent</exception>
        ...
        /// <summary>
        /// Given a ciphertext encrypted modulo q_1...q_k, this function switches the modulus down until the parameters
        /// reach the given ParmsId and scales the message down accordingly.
        /// </summary>
        /// <remarks>
        /// Given a ciphertext encrypted modulo q_1...q_k, this function switches the modulus down until the parameters
        /// reach the given ParmsId and scales the message down accordingly. Dynamic memory allocations in the process
        ...
        /// <summary>
        /// Given a ciphertext encrypted modulo q_1...q_k, this function switches the modulus down until the parameters
        /// reach the given ParmsId, scales the message down accordingly, and stores the result in the destination
        /// parameter.
        /// </summary>
        /// <remarks>
        /// Given a ciphertext encrypted modulo q_1...q_k, this function switches the modulus down until the parameters
        ...
        /// <remarks>
        /// Multiplies several ciphertexts together. This function computes the product of several ciphertext given as
        /// an IEnumerable and stores the result in the destination parameter. The multiplication is done in a
        /// depth-optimal order, and relinearization is performed automatically after every multiplication in the
        /// process. In relinearization the given relinearization keys are used. Dynamic memory allocations in the
        ...
        /// </summary>
        /// <remarks>
        /// This functions raises encrypted to a power. Dynamic memory allocations in the process are allocated from the
        /// memory pool pointed to by the given MemoryPoolHandle. The exponentiation is done in a depth-optimal order,
        /// and relinearization is performed automatically after every multiplication in the process. In relinearization
        /// the given relinearization keys are used.
        /// </remarks>
        ...
        /// <summary>
        /// Adds a ciphertext and a plaintext and stores the result in encrypted.
        /// </summary>
        /// <param name="encrypted">The ciphertext to add</param>
        /// <param name="plain">The plaintext to add</param>
        /// <exception cref="ArgumentNullException">if encrypted or plain is null</exception>
        /// <exception cref="ArgumentException">if encrypted or plain is not valid for the encryption
        /// parameters</exception>
        /// <exception cref="ArgumentException">if encrypted or plain is not in the default NTT form</exception>
        /// <exception cref="ArgumentException">if encrypted and plain are at different level or scale</exception>
        /// <exception cref="InvalidOperationException">if result ciphertext is transparent</exception>
        ...
        /// </summary>
        /// <remarks>
        /// This function adds a ciphertext and a plaintext and stores the result in the destination parameter.
        /// </remarks>
        /// <param name="encrypted">The ciphertext to add</param>
        /// <param name="plain">The plaintext to add</param>
        /// <param name="destination">The ciphertext to overwrite with the addition result</param>
        /// <exception cref="ArgumentNullException">if encrypted, plain, or destination is null</exception>
        /// <exception cref="ArgumentException">if encrypted or plain is not valid for the encryption
        /// parameters</exception>
        /// <exception cref="ArgumentException">if encrypted or plain is not in the default NTT form</exception>
        /// <exception cref="ArgumentException">if encrypted and plain are at different level or scale</exception>
        ...
        /// <summary>
        /// Subtracts a plaintext from a ciphertext and stores the result in encrypted.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// This function subtracts a plaintext from a ciphertext and stores the result in the destination parameter.
        /// </remarks>
        /// <param name="encrypted">The ciphertext to subtract from</param>
        /// <param name="plain">The plaintext to subtract</param>
        /// <param name="destination">The ciphertext to overwrite with the subtraction result</param>
        ...
        /// </summary>
        /// <remarks>
        /// This functions applies the Number Theoretic Transform to a plaintext by first embedding integers modulo the
        /// plaintext modulus to integers modulo the coefficient modulus and then performing David Harvey's NTT on the
        /// resulting polynomial. The transformation is done with respect to encryption parameters corresponding to a
        /// given parmsId. For the operation to be valid, the plaintext must have degree less than PolyModulusDegree and
        /// each coefficient must be less than the plaintext modulus, i.e., the plaintext must be a valid plaintext
        /// under the current encryption parameters. Dynamic memory allocations in the process are allocated from the
        /// memory pool pointed to by the given MemoryPoolHandle.
        /// </remarks>
        ...
        /// plaintext modulus to integers modulo the coefficient modulus and then performing David Harvey's NTT on the
        /// resulting polynomial. The transformation is done with respect to encryption parameters corresponding to a
        /// given ParmsId. The result is stored in the destinationNTT parameter. For the operation to be valid, the
        /// plaintext must have degree less than PolyModulusDegree and each coefficient must be less than the plaintext
        /// modulus, i.e., the plaintext must be a valid plaintext under the current encryption parameters. Dynamic
        /// memory allocations in the process are allocated from the memory pool pointed to by the given
        /// MemoryPoolHandle.
        /// </remarks>
        /// <param name="plain">The plaintext to transform</param>
        ...
        /// <param name="pool">The MemoryPoolHandle pointing to a valid memory pool</param>
        /// <exception cref="ArgumentNullException">if plain, parmsId, or destinationNTT is null</exception>
        /// <exception cref="ArgumentException">if plain is already in NTT form</exception>
        /// <exception cref="ArgumentException">if plain or parmsId is not valid for the encryption
        /// parameters</exception>
        /// <exception cref="ArgumentException">if pool is uninitialized</exception>
        ...
        /// <remarks>
        /// Transforms a ciphertext to NTT domain. This functions applies David Harvey's Number Theoretic Transform
        /// separately to each polynomial of a ciphertext. The result is stored in the DestinationNTT parameter.
        /// </remarks>
        /// <param name="encrypted">The ciphertext to transform</param>
        /// <param name="destinationNTT">The ciphertext to overwrite with the transformed result</param>
        /// <exception cref="ArgumentNullException">if encrypted or destinationNTT is null</exception>
        /// <exception cref="ArgumentException">if encrypted is not valid for the encryption parameters</exception>
        /// <exception cref="ArgumentException">if encrypted is already in NTT form</exception>
        /// <exception cref="InvalidOperationException">if result ciphertext is transparent</exception>
        ...
        /// <exception cref="ArgumentNullException">if encryptedNTT or destination is null</exception>
        /// <exception cref="ArgumentException">if encryptedNTT is not valid for the encryption parameters</exception>
        /// <exception cref="ArgumentException">if encryptedNTT is not in NTT form</exception>
        /// <exception cref="InvalidOperationException">if result ciphertext is transparent</exception>
        ...
        /// <remarks>
        /// <para>
        /// Applies a Galois automorphism to a ciphertext. To evaluate the Galois automorphism, an appropriate set of
        /// Galois keys must also be provided. Dynamic memory allocations in the process are allocated from the memory
        /// pool pointed to by the given MemoryPoolHandle.
        /// </para>
        /// <para>
        ...
        /// <summary>
        /// Applies a Galois automorphism to a ciphertext and writes the result to the destination parameter.
        /// </summary>
        /// <remarks>
        /// <para>
        /// Applies a Galois automorphism to a ciphertext and writes the result to the destination parameter. To
        /// evaluate the Galois automorphism, an appropriate set of Galois keys must also be provided. Dynamic memory
        /// allocations in the process are allocated from the memory pool pointed to by the given MemoryPoolHandle.
        /// </para>
        /// <para>
        /// The desired Galois automorphism is given as a Galois element, and must be an odd integer in the interval
        ...
        /// </summary>
        /// <remarks>
        /// When using the CKKS scheme, this function rotates the encrypted plaintext vector cyclically to the left
        /// (steps &gt; 0) or to the right (steps &lt; 0). Since the size of the batched matrix is 2-by-(N/2), where N
        /// is the degree of the polynomial modulus, the number of steps to rotate must have absolute value at most
        /// N/2-1. Dynamic memory allocations in the process are allocated from the memory pool pointed to by the given
        /// MemoryPoolHandle.
        /// </remarks>
        /// <param name="encrypted">The ciphertext to rotate</param>
        /// <param name="steps">The number of steps to rotate (positive left, negative right)</param>
        ...
        /// <remarks>
        /// When using the CKKS scheme, this function rotates the encrypted plaintext vector cyclically to the left
        /// (steps &gt; 0) or to the right (steps &lt; 0) and writes the result to the destination parameter. Since the
        /// size of the batched matrix is 2-by-(N/2), where N is the degree of the polynomial modulus, the number of
        /// steps to rotate must have absolute value at most N/2-1. Dynamic memory allocations in the process are
        /// allocated from the memory pool pointed to by the given MemoryPoolHandle.
        /// </remarks>
        /// <param name="encrypted">The ciphertext to rotate</param>
        /// <param name="steps">The number of steps to rotate (positive left, negative right)</param>
        ...
        /// </summary>
        /// <remarks>
        /// When using the CKKS scheme, this function complex conjugates all values in the underlying plaintext. Dynamic
        /// memory allocations in the process are allocated from the memory pool pointed to by the given
        /// MemoryPoolHandle.
        /// </remarks>
        /// <param name="encrypted">The ciphertext to rotate</param>
        ...
        /// </summary>
        /// <remarks>
        /// When using the CKKS scheme, this function complex conjugates all values in the underlying plaintext, and
        /// writes the result to the destination parameter. Dynamic memory allocations in the process are allocated from
        /// the memory pool pointed to by the given MemoryPoolHandle.
        /// </remarks>
        /// <param name="encrypted">The ciphertext to rotate</param>
        /// <param name="galoisKeys">The Galois keys</param>
