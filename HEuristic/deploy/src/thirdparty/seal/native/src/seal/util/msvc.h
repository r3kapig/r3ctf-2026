...
#pragma message(                                                          \
    "Disabling `if constexpr` based on _MSVC_LANG value " SEAL_STRINGIZE( \
...
#pragma message(                                                              \
    "Disabling `[[maybe_unused]]` based on _MSVC_LANG value " SEAL_STRINGIZE( \
...
#pragma message(                                                           \
    "Disabling `[[nodiscard]]` based on _MSVC_LANG value " SEAL_STRINGIZE( \
